...
export type TestRivalry = Omit<Schema['Rivalry']['type'], 'game' | 'contests' | 'tierLists'> &
  Partial<Pick<Schema['Rivalry']['type'], 'game' | 'contests' | 'tierLists'>>;

export type TestTierList = Omit<Schema['TierList']['type'], 'rivalry' | 'tierSlots'> &
...
export type TestFighter = Omit<Schema['Fighter']['type'], 'game' | 'tierSlots'> &
