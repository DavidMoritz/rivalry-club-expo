        ...
        <ScrollView contentContainerStyle={scrollContentStyle} style={scrollViewStyle}>
          ...
          <View style={sectionContainerTopStyle}>
            ...
            <Text style={bodyTextWithMarginStyle}>
              Challenge your rival with customized, auto-balancing tier lists! Learn this exciting
              new way to play your favorite fighting game.
            </Text>
          </View>
          ...
          <View style={sectionContainerStyle}>
            ...
            <Text style={bodyTextWithBottomMarginStyle}>
              Most tiers contain 12 characters. Rank characters from your best in S Tier down to
              your worst in F Tier.
            </Text>
          ...
          <View style={sectionContainerStyle}>
            ...
            <Text style={ruleTextStyle}>
              <Text style={boldTextStyle}>2 Stock Victory:</Text> Winner moves down one tier AND
              loser moves up one tier
            </Text>
            <Text style={ruleTextStyle}>
              <Text style={boldTextStyle}>3 Stock Victory:</Text> Both players move one tier, plus
              an additional tier move for either winner or loser (randomly chosen)
            </Text>
          </View>

          {/* Section 5: Character Rankings */}
          <View style={sectionContainerStyle}>
            <Text style={sectionTitleStyle}>5. Character Movement Within Tiers</Text>
            <Text style={bodyTextStyle}>
              As contests are resolved, fighters automatically move up or down within your tier list
          ...
          <View style={sectionContainerStyle}>
            ...
            <Text style={bodyTextWithBottomMarginStyle}>
              If a player moves below F Tier, he gains a Prestige level (shown as +1, +2, etc.).
              Each prestige level adds a 20% damage handicap against him.
            </Text>
            <Text style={bodyTextWithBottomMarginStyle}>
              For example: If a player has +2 prestige over his rival, it means he'll have an
              approximately equal chance of winning or losing when playing with a 40% damage
              handicap. These are the bragging rights inherent in prestige!
            </Text>
            <Text style={bodyTextStyle}>
              If his rival thinks he is better, he will have to prove it by winning more to force
              the prestige down and remove the handicap. The handicap applies until the player is
              forced back up to his regular tier list.
            </Text>
          </View>
